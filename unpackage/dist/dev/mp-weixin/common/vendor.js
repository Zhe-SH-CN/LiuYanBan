...
const p = h('{\n    "address": [\n        "127.0.0.1",\n        "172.20.10.11"\n    ],\n    "debugPort": 2497,\n    "initialLaunchType": "remote",\n    "servePort": 2498,\n    "skipFiles": [\n        "<node_internals>/**/*.js",\n        "D:/C-Program Files/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), m = h('[{"provider":"aliyun","spaceName":"show","spaceId":"bc87bd76-5911-4f8c-88ec-be8ce0415b9c","clientSecret":"Oi0aLFz+KVeyt1D6bLz4nw==","endpoint":"https://api.bspapp.com"}]');
let _ = "";
try {
  _ = "__UNI__A7C8E70";
} catch (e) {
...
var H = { request: (e) => index.request(e), uploadFile: (e) => index.uploadFile(e), setStorageSync: (e, t2) => index.setStorageSync(e, t2), getStorageSync: (e) => index.getStorageSync(e), removeStorageSync: (e) => index.removeStorageSync(e), clearStorageSync: () => index.clearStorageSync() }, W = { "uniCloud.init.paramRequired": "{param} required", "uniCloud.uploadFile.fileError": "filePath should be instance of File" };
              ...
              throw new Error(`Invalid errorOptions.type: ${r2.type}`);
            {
              const { confirm: e3 } = await async function({ title: e4, content: t3, showCancel: n5, cancelText: s4, confirmText: o3 } = {}) {
                return new Promise((r3, i3) => {
                  index.showModal({ title: e4, content: t3, showCancel: n5, cancelText: s4, confirmText: o3, success(e5) {
                    r3(e5);
                  }, fail() {
